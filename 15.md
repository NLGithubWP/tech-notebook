...
We cannot recorded the states of all processes and channels at the same instant, but we can record meaningful globla system state. 
...
1. p record state in finite time
2. p send marker to q
3. q record state in finite time
