...
![image-20211026154015438]({{ site.baseurl }}/img/paper-img/image-20211026154015438.png)
...
![image-20211026162514401]({{ site.baseurl }}/img/paper-img/image-20211026162514401.png)

# Architectures

## Middle proxy

![image-20211026171350904]({{ site.baseurl }}/img/paper-img/image-20211026171350904.png)
...
![image-20211026171621767]({{ site.baseurl }}/img/paper-img/image-20211026171621767.png)
...
![image-20211026172036127]({{ site.baseurl }}/img/paper-img/image-20211026172036127.png)
...
![image-20211026172736364]({{ site.baseurl }}/img/paper-img/image-20211026172736364.png)
...
![image-20211026195158452]({{ site.baseurl }}/img/paper-img/image-20211026195158452.png)

## TCP/UDP passthrough load balancers

![image-20211026194601695]({{ site.baseurl }}/img/paper-img/image-20211026194601695.png)

![image-20211026194750697]({{ site.baseurl }}/img/paper-img/image-20211026194750697.png)
...
![image-20211026195820615]({{ site.baseurl }}/img/paper-img/image-20211026195820615.png)
...
![image-20211026202726532]({{ site.baseurl }}/img/paper-img/image-20211026202726532.png)

## Fault tolerance and scaling via clusters with distributed consistent hashing

![image-20211026203410694]({{ site.baseurl }}/img/paper-img/image-20211026203410694.png)
...
![image-20211026211315521]({{ site.baseurl }}/img/paper-img/image-20211026211315521.png)
