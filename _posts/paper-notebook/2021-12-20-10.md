...
![image-20211225172959309]({{ site.baseurl }}/img/paper-img/image-20211225172959309.png)

![image-20211225181308294]({{ site.baseurl }}/img/paper-img/image-20211225181308294.png)
...
![image-20211226145119529]({{ site.baseurl }}/img/paper-img/image-20211226145119529.png)

according to Proposition 1.

![image-20211226150008239]({{ site.baseurl }}/img/paper-img/image-20211226150008239.png)
...
![image-20211226145156394]({{ site.baseurl }}/img/paper-img/image-20211226145156394.png)
...
![image-20211225225420848]({{ site.baseurl }}/img/paper-img/image-20211225225420848.png)

## Approximating the Trace Norm of NTK

![image-20211225225545221]({{ site.baseurl }}/img/paper-img/image-20211225225545221.png)
...
![image-20211225230032957]({{ site.baseurl }}/img/paper-img/image-20211225230032957.png)

3. further approximate the summation over m/b mini-batches in (11) by one single uniformly randomly sampled mini-batch Xj

![image-20211225230133764]({{ site.baseurl }}/img/paper-img/image-20211225230133764.png)

## Optimization and Search Algorithm

with the approximation in (12), our reformulated NAS problem (8) can be transformed into

![image-20211225230753501]({{ site.baseurl }}/img/paper-img/image-20211225230753501.png)
...
![image-20211225231625672]({{ site.baseurl }}/img/paper-img/image-20211225231625672.png)
...
![image-20211225232009358]({{ site.baseurl }}/img/paper-img/image-20211225232009358.png)
...
![image-20211225232645184]({{ site.baseurl }}/img/paper-img/image-20211225232645184.png)
...
![image-20211225233128186]({{ site.baseurl }}/img/paper-img/image-20211225233128186.png)

![image-20211225233242861]({{ site.baseurl }}/img/paper-img/image-20211225233242861.png)

This simple and efficient solution in (18) can already allow us to select architectures with competitive performances.

![image-20211225233707249]({{ site.baseurl }}/img/paper-img/image-20211225233707249.png)
...
![image-20211226133539003]({{ site.baseurl }}/img/paper-img/image-20211226133539003.png)
...
![image-20211226134146567]({{ site.baseurl }}/img/paper-img/image-20211226134146567.png)
...
![image-20211226135441955]({{ site.baseurl }}/img/paper-img/image-20211226135441955.png)
...
![image-20211226135601379]({{ site.baseurl }}/img/paper-img/image-20211226135601379.png)
