...
- Proof: The proof follows assume-contradiction method. 
  ...
  ```
  Suppose at length of B2 is l2, and B2' is conflicting with B2 => B2' must be proposed before e (Fact3) 
  => B2' parent chain must has length l2-1 and every honest participant has seen it (by Fact1).
  => At epoch e+1, leader must propose an block at hight greater than l2 
