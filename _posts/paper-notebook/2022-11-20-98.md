...
This paper presents Algorand, a new cryptocurrency designed to confirm **transactions on the order of one minute.** It mainly relies on the BA protocol, BA-Star, to reach a consensus on a new block with low latency and without the possibility of forks. 
