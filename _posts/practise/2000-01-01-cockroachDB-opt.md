...
![image-20211028154031616]({{ site.baseurl }}/img/a_img_store/image-20211028154031616.png)
...
![image-20211028154306793]({{ site.baseurl }}/img/a_img_store/image-20211028154306793.png)
...
3. Use storing to store **hot data cols in index**, and also store join key.
   ...
   ![image-20211028154437616]({{ site.baseurl }}/img/a_img_store/image-20211028154437616.png)
...
5. l If must define in sequential keys, use hash-sharded index. 
   ...
   ![image-20211028154505841]({{ site.baseurl }}/img/a_img_store/image-20211028154505841.png)

   ![image-20211028154513220]({{ site.baseurl }}/img/a_img_store/image-20211028154513220.png)
...
7. l For single-column pk, use UUID, gen_random_uuid() function, which ensure the pk value will be unique and well-distributed across a cluster
   ...
   **这个uuid无法用于查询，但是可以用于多个表的join**
   ...
   ![image-20211028154559441]({{ site.baseurl }}/img/a_img_store/image-20211028154636919.png)

Add proper column constraints

![image-20211028154636919]({{ site.baseurl }}/img/a_img_store/image-20211028154636919.png)
...
![image-20211028154732484]({{ site.baseurl }}/img/a_img_store/image-20211028154732484.png)

![image-20211028154736635]({{ site.baseurl }}/img/a_img_store/image-20211028154736635.png)
...
![image-20211028155026069]({{ site.baseurl }}/img/a_img_store/image-20211028155026069.png)

![image-20211028155032359]({{ site.baseurl }}/img/a_img_store/image-20211028155032359.png)
...
![image-20211028155113030]({{ site.baseurl }}/img/a_img_store/image-20211028155113030.png)
